...
def post_share(request, post_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            cd = form.cleaned_data # Validated data is retrieved - Dictionary of form fields and their values
            # ... send email
...
def post_comment(request, post_id):
    ...
    if form.is_valid():
        # Create an instance of the model that the form is linked to
        comment = form.save(commit=False) # Model instance is created but not saved to the database
        # Modify the object before saving it
        comment.post = post
